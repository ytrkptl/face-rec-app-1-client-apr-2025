  ...
  const onRegisterStep1 = async () => {
    ...
    if (
      ...
      try {
        ...
        if (registerName) {
          userObj.profilePhotoUrl = `https://avatar-letter.yatrik.dev/api/file/set1/big/${registerName[0].toLowerCase()}/png`;
        } else if (registerEmail) {
          userObj.profilePhotoUrl = `https://avatar-letter.yatrik.dev/api/file/set1/big/${registerEmail[0].toLowerCase()}/png`;
        } else {
          userObj.profilePhotoUrl = `https://avatar-letter.yatrik.dev/api/file/set1/big/u/png`;
        }
